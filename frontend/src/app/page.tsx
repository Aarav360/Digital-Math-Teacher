...
export default function LandingPage() {
  ...
  return (
    <div className="landing-page min-h-screen bg-white antialiased scroll-smooth">
      {/* Plasma background */}
        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-600 to-indigo-600 flex items-center justify-center shadow-sm">
              <span className="text-white font-bold text-sm">&sum;</span>
            </div>
      ...
      <section className="relative min-h-screen flex items-center pt-16 overflow-hidden landing-grid-bg">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <div className="space-y-8">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 border border-blue-100 text-xs font-medium text-blue-600">
          ...
          <div className="relative lg:h-[600px] flex items-center justify-center">
            <div className="landing-whiteboard w-full max-w-lg rounded-2xl p-6 relative overflow-hidden">
              ...
              {/* Problem */}
              <div className="mb-6">
                <div className="text-xs text-slate-400 mb-1 uppercase tracking-wider font-medium">Problem</div>
                <div className="text-lg font-medium text-slate-800">Solve for x: 2x&sup2; + 4x &minus; 6 = 0</div>
              </div>
              ...
              <div className="space-y-4 font-mono text-lg">
                <div className="flex items-start gap-3 opacity-80">
                  ...
                  <div className="text-blue-600">x&sup2; + 2x &minus; 3 = 0</div>
                </div>
                <div className="flex items-start gap-3 opacity-80">
                  <span className="text-slate-400">2.</span>
                  <div className="text-blue-600">(x + 3)(x &minus; 1) = 0</div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-slate-400">3.</span>
                  <div className="flex items-center gap-2 text-blue-600">
                    x = &minus;3 or x = 1
                    <span className="text-green-600 text-sm font-medium bg-green-50 px-2 py-0.5 rounded-full font-sans">&check; Correct</span>
                  </div>
                </div>
              </div>

              {/* AI Feedback Panel */}
              <div className="mt-6 landing-glass rounded-xl p-4 border border-blue-100 shadow-lg">
                <div className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center shrink-0">
                    <span className="text-blue-600 text-xs font-bold">AI</span>
                  </div>
                  <div>
                    <div className="text-sm font-semibold text-blue-900 mb-1">Step 3 Verified</div>
                    <div className="text-xs text-slate-600">Great job factoring! Both solutions satisfy the original equation.</div>
                  </div>
                </div>
              </div>

              {/* Grid overlay */}
              <div className="absolute inset-0 pointer-events-none" style={{ backgroundImage: "linear-gradient(rgba(148,163,184,0.03) 1px,transparent 1px),linear-gradient(90deg,rgba(148,163,184,0.03) 1px,transparent 1px)", backgroundSize: "20px 20px" }} />
            </div>
      ...
      {/* How It Works */}
      <section id="how-it-works" className="py-32 relative bg-slate-50/50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20 landing-reveal" ref={addRevealRef}>
            ...
            <p className="text-slate-500 max-w-2xl mx-auto text-lg">Three simple steps to smarter math practice</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="landing-step-card rounded-2xl p-8 landing-reveal" ref={addRevealRef}>
              ...
              <h3 className="text-xl font-semibold mb-3 text-slate-900">Write by Hand</h3>
            ...
            <div className="landing-step-card rounded-2xl p-8 landing-reveal" ref={addRevealRef}>
              ...
              <h3 className="text-xl font-semibold mb-3 text-slate-900">Get AI Feedback</h3>
              <p className="text-slate-600 leading-relaxed">
            ...
            <div className="landing-step-card rounded-2xl p-8 landing-reveal" ref={addRevealRef}>
              ...
              <h3 className="text-xl font-semibold mb-3 text-slate-900">Chat &amp; Learn</h3>
              <p className="text-slate-600 leading-relaxed">
      ...
      <section id="features" className="py-32 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
            ...
            <div className="relative landing-reveal" ref={addRevealRef}>
              <div className="bg-white rounded-2xl p-8 border border-slate-200 shadow-xl">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <div className="font-semibold text-slate-900">Step 2 Analysis</div>
                    <div className="text-sm text-slate-500">Algebra 2 &bull; Quadratic Equations</div>
                  </div>
                </div>
                <div className="space-y-3 font-mono text-sm">
                  <div className="p-3 rounded-lg bg-red-50 border border-red-100 text-red-700">
                    ...
                    <div className="text-red-600/70 text-xs">When moving -6 to the right side, it should become +6, not -6.</div>
                  </div>
                  <div className="p-3 rounded-lg bg-blue-50 border border-blue-100 text-blue-700">
                    <div className="text-xs text-blue-600/70">Try: Add 6 to both sides first, then divide by 2.</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: "M13 10V3L4 14h7v7l9-11h-7z", title: "Instant Feedback", desc: "Real-time analysis as you work. No waiting, no delays.", color: "blue" },
              { icon: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253", title: "Algebra 1 to Calc 3", desc: "Comprehensive coverage from middle school to college math.", color: "indigo" },
              { icon: "M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z", title: "Smart Tutor Chat", desc: "Ask questions naturally. Get hints, not just answers.", color: "cyan" },
              { icon: "M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z", title: "Privacy First", desc: "Your work is private. No public sharing of your data.", color: "green" },
            ].map((feature, i) => (
              <div key={i} className="landing-feature-card rounded-2xl p-6 landing-reveal" ref={addRevealRef}>
                <div className={`w-10 h-10 rounded-xl bg-${feature.color}-50 flex items-center justify-center mb-4 text-${feature.color}-600`}>
      ...
      <section className="py-32 relative bg-slate-50/50">
        <div className="max-w-5xl mx-auto px-6 text-center landing-reveal" ref={addRevealRef}>
          <h2 className="text-3xl md:text-5xl font-bold mb-12 text-slate-900">Who it&apos;s for</h2>
          <div className="flex flex-wrap justify-center gap-4">
            {[
              { label: "6th\u20138th Grade", color: "blue" },
              { label: "High School Math", color: "indigo" },
              { label: "Intro College Math", color: "cyan" },
              { label: "Self-Study", color: "green" },
              { label: "Classroom Demos", color: "amber" },
            ].map((item, i) => (
              <div key={i} className={`px-6 py-3 rounded-full bg-white border border-${item.color}-100 text-${item.color}-700 font-medium shadow-sm`}>
                {item.label}
              </div>
            ))}
          </div>
          <p className="mt-8 text-slate-500">Designed for students who want to understand the &ldquo;why&rdquo; behind every step.</p>
        </div>
      </section>
      ...
      <section id="about" className="py-32 relative">
        <div className="max-w-4xl mx-auto px-6">
          <div className="bg-white rounded-3xl p-8 md:p-12 border border-slate-200 shadow-xl landing-reveal" ref={addRevealRef}>
            <h2 className="text-2xl md:text-3xl font-bold mb-8 text-center text-slate-900">What you should know</h2>
      ...
      <section className="py-32 relative overflow-hidden bg-slate-50">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10 landing-reveal" ref={addRevealRef}>
          <h2 className="text-4xl md:text-6xl font-bold mb-6 text-slate-900">Ready to start learning?</h2>
          <p className="text-xl text-slate-600 mb-12">No sign-up required to try. Jump in and solve your first problem in seconds.</p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 rounded bg-gradient-to-br from-blue-600 to-indigo-600 flex items-center justify-center">
                <span className="text-white font-bold text-xs">&sum;</span>
              </div>
              <span className="font-semibold text-slate-900">Digital Math Teacher</span>
            </div>

            <div className="flex gap-8 text-sm text-slate-500">
              <Link href="/about" className="hover:text-slate-900 transition-colors">About / Help</Link>
